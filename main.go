...
import (
	...
	"github.com/pborman/uuid" //ElasticSearch里用ID来区分数据
	elastic "gopkg.in/olivere/elastic.v3"
)

var mySigningKey = []byte("jiegongsecret")
...
const (
	...
	DISTANCE = "200km"
	// Needs to update
	PROJECT_ID  = "river-cocoa-206502"
	BT_INSTANCE = "around-post"
	// Needs to update this URL if you deploy it to cloud.
	ES_URL = "http://104.197.167.215:9200"
	// Needs to update this bucket based on your gcs bucket name.
	BUCKET_NAME = "post-images-206520"
...
func main() {
	...
	if !exists {
		// Create a new index.
		//把location标记成geo_point，转化成K-D tree管理的方式
		//第一次创建，下次再来就不用创建了
		mapping := `{
			"mappings":{
				"post":{
